...
def return_params(inner_size):
    convlstm_encoder_params1 = [
        [
            OrderedDict({'conv1_leaky_1': [1, 8, 7, STRIDES[0], 3]}),
            OrderedDict({'conv2_leaky_1': [inner_size[0], inner_size[1], 5, STRIDES[1], 2]}),
            OrderedDict({'conv3_leaky_1': [inner_size[1], inner_size[1], 3, STRIDES[2], 1]}),
        ],

        [
            ConvLSTM(input_channel=8, num_filter=inner_size[0], b_h_w=(batch_size, HEIGHT//STRIDES_TOTAL[0], HEIGHT//STRIDES_TOTAL[0]),
                    kernel_size=3, stride=1, padding=1),
            ConvLSTM(input_channel=inner_size[1], num_filter=inner_size[1], b_h_w=(batch_size, HEIGHT//STRIDES_TOTAL[1], HEIGHT//STRIDES_TOTAL[1]),
                    kernel_size=3, stride=1, padding=1),
            ConvLSTM(input_channel=inner_size[1], num_filter=inner_size[1], b_h_w=(batch_size, HEIGHT//STRIDES_TOTAL[2], HEIGHT//STRIDES_TOTAL[2]),
                    kernel_size=3, stride=1, padding=1),
        ]
    ]
    ...
    convlstm_forecaster_params1 = [
        [
            OrderedDict({'deconv1_leaky_1': [inner_size[1], inner_size[1], 4, STRIDES[2], 1]}),
            OrderedDict({'deconv2_leaky_1': [inner_size[1], inner_size[0], 6, STRIDES[1], 2]}),
            OrderedDict({
                'deconv3_leaky_1': [inner_size[0], 8, 8, STRIDES[0], 3],
                'conv3_leaky_2': [8, 8, 3, 2, 1],
                'conv3_3': [8, 1, 1, 1, 0]
            }),
        ],
        ...
        [
            ...
            ConvLSTM(input_channel=inner_size[1], num_filter=inner_size[1], b_h_w=(batch_size, HEIGHT//STRIDES_TOTAL[1], HEIGHT//STRIDES_TOTAL[1]),
                    kernel_size=3, stride=1, padding=1),
            ConvLSTM(input_channel=inner_size[0], num_filter=inner_size[0], b_h_w=(batch_size, HEIGHT//STRIDES_TOTAL[0], HEIGHT//STRIDES_TOTAL[0]),
                    kernel_size=3, stride=1, padding=1),
        ]
    ]
...
def return_params_trajgru(inner_size):
    encoder_params = [
        ...
        [   
        TrajGRU(input_channel=8, num_filter=inner_size[0], b_h_w=(batch_size, HEIGHT//STRIDES_TOTAL[0], HEIGHT//STRIDES_TOTAL[0]), zoneout=0.0, L=13,
                i2h_kernel=(3, 3), i2h_stride=(1, 1), i2h_pad=(1, 1),
                h2h_kernel=(5, 5), h2h_dilate=(1, 1),
                act_type=cfg.MODEL.RNN_ACT_TYPE),

        TrajGRU(input_channel=inner_size[1], num_filter=inner_size[1], b_h_w=(batch_size, HEIGHT//STRIDES_TOTAL[1], HEIGHT//STRIDES_TOTAL[1]), zoneout=0.0, L=13,
                i2h_kernel=(3, 3), i2h_stride=(1, 1), i2h_pad=(1, 1),
                h2h_kernel=(5, 5), h2h_dilate=(1, 1),
                act_type=cfg.MODEL.RNN_ACT_TYPE),
        TrajGRU(input_channel=inner_size[1], num_filter=inner_size[1], b_h_w=(batch_size, HEIGHT//STRIDES_TOTAL[2], HEIGHT//STRIDES_TOTAL[2]), zoneout=0.0, L=9,
                i2h_kernel=(3, 3), i2h_stride=(1, 1), i2h_pad=(1, 1),
                h2h_kernel=(3, 3), h2h_dilate=(1, 1),
                act_type=cfg.MODEL.RNN_ACT_TYPE)
        ]
    ...
    forecaster_params = [
        ...
        [
            TrajGRU(input_channel=inner_size[1], num_filter=inner_size[1], b_h_w=(batch_size, HEIGHT//STRIDES_TOTAL[2], HEIGHT//STRIDES_TOTAL[2]), zoneout=0.0, L=13,
                    i2h_kernel=(3, 3), i2h_stride=(1, 1), i2h_pad=(1, 1),
                    h2h_kernel=(3, 3), h2h_dilate=(1, 1),
                    act_type=cfg.MODEL.RNN_ACT_TYPE),
            ...
            TrajGRU(input_channel=inner_size[1], num_filter=inner_size[1], b_h_w=(batch_size, HEIGHT//STRIDES_TOTAL[1], HEIGHT//STRIDES_TOTAL[1]), zoneout=0.0, L=13,
                    ...
                    h2h_kernel=(5, 5), h2h_dilate=(1, 1),
                    act_type=cfg.MODEL.RNN_ACT_TYPE),
            TrajGRU(input_channel=inner_size[0], num_filter=inner_size[0], b_h_w=(batch_size, HEIGHT//STRIDES_TOTAL[0], HEIGHT//STRIDES_TOTAL[0]), zoneout=0.0, L=9,
                    i2h_kernel=(3, 3), i2h_stride=(1, 1), i2h_pad=(1, 1),
                    h2h_kernel=(5, 5), h2h_dilate=(1, 1),
                    act_type=cfg.MODEL.RNN_ACT_TYPE)
        ]
