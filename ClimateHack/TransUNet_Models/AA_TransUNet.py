...
from TransUNet_Models.bottleneck import *
#from Precipitation_Forecasting.precipitation_lightning_base import Precip_regression_base
from TransUNet_Models.encoder import ViT
from TransUNet_Models.decoder import SingleConv, UpDS
from TransUNet_Models.cbam import *

class AA_TransUnet(nn.Module):
    def __init__(self, hparams):
        """
        Args:
            img_dim: the img dimension
            in_channels: channels of the input
            out_channels: desired segmentation classes
        ...
        """
        super(AA_TransUnet, self).__init__()
        ...
        self.cbam4 = CBAM(64)
        self.dec4 = UpDS(64, 32)
        self.cbam5 = CBAM(32)
        self.conv1x1 = nn.Conv2d(in_channels=32, out_channels=hparams['out_channels'], kernel_size=1)
