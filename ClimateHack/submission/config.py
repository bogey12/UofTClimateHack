...
__C.HKO.EVALUATION.CENTRAL_REGION = (32, 32, 96, 96)
...
__C.HKO.BENCHMARK.IN_LEN = 12   # The maximum input length to ensure that all models are tested on the same set of input data
...
__C.HKO.BENCHMARK.STRIDES = [2, 2, 2]   # The stride
...
__C.HKO.ITERATOR.WIDTH = 128
__C.HKO.ITERATOR.HEIGHT = 128
