...
# ConvGRU required modules and definitions
class ConvGRUCell(nn.Module):
    ...
    def init_hidden(self, input):
        ...
        return torch.zeros(bs, self.hidden_dim, h, w, device=input.device)
...
if __name__ == "__main__":
    ...
    model = ConvGRU(1,24,(3,3),1)
    layer_output, last_state_list = model(x)
    print(layer_output.shape)
    print(last_state_list[0].shape)