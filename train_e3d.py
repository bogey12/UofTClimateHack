...
if __name__ == '__main__':
    ...
    ch_validation = ClimateHackDataset(validation_ds, crops_per_slice=5, day_limit=3, outputs=N_IMS)
    ...
    trainer = pl.Trainer(gpus=1, precision=32, accumulate_grad_batches=7)#,callbacks=[early_stop])#, detect_anomaly=True)#, overfit_batches=1)#, benchmark=True)#, limit_train_batches=1)
